package com.example.user.studentdatabase;
...
//FirebaseDatabase root,dba;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Show1.setOnClickListener(new View.OnClickListener () {
            ...
            public void onClick(View v) {
                // TODO Auto-generated method stub
                showMessage("Student Management Application", "Developed By Prathviraj,Shashank,Pradhan and JItesh team");
            }
        });
